// request.js
// const baseUrl = 'http://jinsiyuma.quanyi163.com/mini'
// const baseUrl = 'https://kinsyomacz.com/mini'
const baseUrl = 'https://jsym.kinsyomacz.com/mini'
const courseBaseUrl = 'https://jsym.kinsyomacz.com';
// const courseBaseUrl = 'http://192.168.2.28:8084'
...
const get = (url, data, is_userid = true, options = {}) => {
	options.type = 'GET';
...
const post2 = (url, data, is_userid = true, options = {}) => {
	options.type = 'POST';
	options.data = data ? data : {};
	options.url = url;
	options.is_userid = is_userid;
...
const post3 = (url, data, skip = 'yes', is_user_id = 'yes', options = {}) => {
	options.type = 'POST';
	options.data = data ? data : {};
	options.url = url;
	options.skip = skip;
...
const get2 = (url, data, skip = 'yes', is_user_id = 'yes', options = {}) => {
	options.type = 'GET';
	options.data = data ? data : {};
	options.url = url;
	options.skip = skip;
